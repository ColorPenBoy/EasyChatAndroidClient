...
object PacketType {
    ...
    const val GROUP_MESSAGE_REQ = 21
    const val GROUP_MESSAGE_RESP = 22
    const val ACCEPT_GROUP_REQ = 17//
    const val ACCEPT_GROUP_RESP = 18//
    const val ACCEPT_REQ = 19//
    const val ACCEPT_RESP = 20//
    const val REGISTER_REQ = 41//
    const val REGISTER_RESP = 42//
    const val UPDATE_PASSWD_REQ = 23//
    const val UPDATE_PASSWD_RESP = 24//
    const val MESSAGE_SELF_RESP = 20
    const val HEART_BEAT_REQ = 30
    const val HEART_BEAT_RESP = 31
    const val SYNC_MESSAGE_REQ = 28//
    const val APPLY_GROUP_REQ = 29//
    const val APPLY_GROUP_RESP = 50//
    const val APPLY_GROUP_SELF_RESP = 51//
